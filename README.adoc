 ...
 * link:docs/containers.asciidoc[crunchy-pgpool] - executes pgpool
 * link:docs/containers.asciidoc[crunchy-pgbadger] - executes pgbadger
 * link:docs/containers.asciidoc[crunchy-watch] - performs a form of automated failover
 ...
 * link:docs/containers.asciidoc[crunchy-dns] - standalone DNS server useful for standalone execution
 * link:docs/containers.asciidoc[crunchy-vacuum] - performs a Postgres VACUUM
 * link:docs/containers.asciidoc[crunchy-dba] - cron scheduler, useful for routine DBA tasks
